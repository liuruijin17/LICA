...
# TODO Set path
COLOR_IMAGES = "/data/ricklrj/Datasets/LLAMAS/color_images"
GRAYSCALE_IMAGES = "/data/ricklrj/Datasets/LLAMAS/grayscale_images"
LABELS = "/data/ricklrj/Datasets/LLAMAS/labels"
