...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        # src_polys  = outputs['pred_boxes'][:, :, 2:][idx]
        ...
        # # pred_xs = src_polys[:, 0] * ys**3 + src_polys[:, 1] * ys**2 + src_polys[:, 2] * ys + src_polys[:, 3]
        # # pred_xs = src_polys[:, 0] / (ys - src_polys[:, 1]) + src_polys[:, 2] + src_polys[:, 3] * ys - src_polys[:, 4]
        ...
        losses = {}
        losses['loss_lowers']  = 0 / num_boxes
        losses['loss_uppers']  = 0 / num_boxes
        losses['loss_polys']   = 0 / num_boxes
